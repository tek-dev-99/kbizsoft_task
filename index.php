...
<div class="row mt-5">
  ...
  <div class="mb-3  mt-3">
    ...
    <div class="row mt-3">
  <div class="col">
    <input type="password" class="form-control password" name="password" id="password" placeholder="Password" aria-label="Password">
  </div>
  <div class="col">
    <input type="password" class="form-control password" name="cpassword" id="cpassword" placeholder="Confirm Password" aria-label="Password">
  </div>
</div>
<div class="row mt-3">
  <div class="col-4">
  ...
  <label class="form-check-label" for="flexCheckChecked">Show Password </label>
     ...
     <button type="submit" class="btn btn-primary">Registered Now</button>
	</div>
